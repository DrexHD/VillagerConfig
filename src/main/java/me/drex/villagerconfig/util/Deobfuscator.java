...
public final class Deobfuscator {
    ...
    private static void downloadAndCacheMappings() {
        ...
        try {
            ...
            VillagerConfig.LOGGER.error("Could not get latest yarn build for version", e);
            return;
        }

        VillagerConfig.LOGGER.info("Downloading deobfuscation mappings: " + yarnVersion + " for the first launch");
        ...
        try {
            ...
            VillagerConfig.LOGGER.error("Could not create data directory!", e);
            return;
        }
        ...
        try {
            ...
            VillagerConfig.LOGGER.error("Failed to downloads mappings!", e);
            return;
        }
